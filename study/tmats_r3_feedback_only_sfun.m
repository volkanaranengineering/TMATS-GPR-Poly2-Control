function tmats_r3_feedback_only_sfun(b)
...
u=pterm+b.Dwork(3).Data;command=max(f.fuelMin,min(f.fuelMax,u));
...
if b.CurrentTime<f.start,b.Dwork(3).Data=b.InputPort(4).Data-pterm;
