function build_tmats_virtual_fuel_model()
root=fileparts(mfilename('fullpath'));tmats_virtual_fuel_setup;
src='GasTurbine_Dyn_Template_GPT_DOB_PTO';m='GasTurbine_Dyn_Template_VirtualFuel';
...
set_param(m,'CloseFcn','','PreLoadFcn','tmats_virtual_fuel_setup;', ...
 'Description','Dual inverse-GPR projection and fuel-domain PI. See TMATS_VIRTUAL_FUEL_USAGE.md.');
add_block('simulink/User-Defined Functions/Level-2 MATLAB S-Function',[m '/Virtual fuel PI'], ...
 'FunctionName','tmats_virtual_fuel_sfun','Parameters','VF','Position',[350 1170 600 1380]);
