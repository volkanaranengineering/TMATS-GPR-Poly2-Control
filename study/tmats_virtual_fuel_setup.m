function [MWS,DOB,PTO,VF]=tmats_virtual_fuel_setup(rpm,fraction,ramps,gains,enabled)
% Fuel-domain PI; fixed gains transfer between operating points.
if nargin<1,rpm=9000;end
if nargin<2,fraction=.1;end
if nargin<3,ramps=[.3 1.5 3];end
if nargin<4,gains=[4 40];end
