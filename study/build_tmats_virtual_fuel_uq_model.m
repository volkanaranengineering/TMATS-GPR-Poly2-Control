function build_tmats_virtual_fuel_uq_model()
root=fileparts(mfilename('fullpath'));tmats_virtual_fuel_uq_setup;
src='GasTurbine_Dyn_Template_GPT_DOB_PTO';m='GasTurbine_Dyn_Template_VirtualFuelUQ';
...
set_param(m,'CloseFcn','','PreLoadFcn','tmats_virtual_fuel_uq_setup;', ...
 'Description','Inverse-GPR feedforward plus uncertainty-scheduled fuel PI. See TMATS_VIRTUAL_FUEL_UQ_USAGE.md.');
add_block('simulink/User-Defined Functions/Level-2 MATLAB S-Function',[m '/Virtual fuel PI'], ...
 'FunctionName','tmats_virtual_fuel_uq_sfun','Parameters','VF','Position',[350 1170 600 1380]);
