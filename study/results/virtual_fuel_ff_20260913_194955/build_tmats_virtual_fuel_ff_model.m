function build_tmats_virtual_fuel_ff_model()
root=fileparts(mfilename('fullpath'));tmats_virtual_fuel_ff_setup;
src='GasTurbine_Dyn_Template_GPT_DOB_PTO';m='GasTurbine_Dyn_Template_VirtualFuelFF';
...
set_param(m,'CloseFcn','','PreLoadFcn','tmats_virtual_fuel_ff_setup;', ...
 'Description','Inverse-GPR feedforward plus fuel-domain PI. See TMATS_VIRTUAL_FUEL_FF_USAGE.md.');
add_block('simulink/User-Defined Functions/Level-2 MATLAB S-Function',[m '/Virtual fuel PI'], ...
 'FunctionName','tmats_virtual_fuel_ff_sfun','Parameters','VF','Position',[350 1170 600 1380]);
...
names={'VF_command','VF_setpoint','VF_feedback','VF_error','VF_acceleration','VF_integral','VF_unsaturated','VF_outside'};
for k=1:numel(names)
